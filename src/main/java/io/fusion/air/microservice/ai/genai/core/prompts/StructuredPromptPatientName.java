...
/**
 * iCare - Diagnosis Structure Prompt for Patient Name
 *
 ...
 */
@StructuredPrompt({
        "Convey the diagnosis for the patient {{patient}} based on the diagnosis available.",
...
public class StructuredPromptPatientName {
