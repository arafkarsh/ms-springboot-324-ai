 ...
 * Source: https://github.com/langchain4j/langchain4j-examples/blob/main/other-examples/src/main/java/embedding/classification/EmbeddingModelTextClassifierExample.java
 *
 ...
 */
@Service
public class CustomerServiceCategoryData {

    private final Map<CustomerServiceCategory, List<String>> serviceData;
    ...
    public CustomerServiceCategoryData() {
        ...
        setupOrderStatus();
        setupReturnsAndExchanges();
        setupFeedbackAndComplaints();
    }
     ...
     * @return
     */
    public Map<CustomerServiceCategory, List<String>> getServiceData() {
        return serviceData;
    }
     ...
     * Setup billing data
     */
    private void setupBillingData() {
        serviceData.put(CustomerServiceCategory.BILLING_AND_PAYMENTS, asList(
    ...
    private void setupTechnicalSupport() {
        serviceData.put(CustomerServiceCategory.TECHNICAL_SUPPORT, asList(
    ...
    private void setupAccountManagement() {
        serviceData.put(CustomerServiceCategory.ACCOUNT_MANAGEMENT, asList(
     ...
     */
    private void setupProductInformation() {
        serviceData.put(CustomerServiceCategory.PRODUCT_INFORMATION, asList(
    ...
    private void setupOrderStatus() {
        serviceData.put(CustomerServiceCategory.ORDER_STATUS, asList(
    ...
    /**
     * Setup Returns and Exchanges
     */
    private void setupReturnsAndExchanges() {
        serviceData.put(CustomerServiceCategory.RETURNS_AND_EXCHANGES, asList(
    ...
    /**
     * Setup Feedback and Complaints
     */
    private void setupFeedbackAndComplaints() {
        serviceData.put(CustomerServiceCategory.FEEDBACK_AND_COMPLAINTS, asList(
