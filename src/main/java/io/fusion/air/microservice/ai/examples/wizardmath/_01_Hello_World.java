...
public class _01_Hello_World {
    ...
    public static void main(String[] args) {
        ...
        ChatLanguageModel model = AiBeans.getChatLanguageModelLlama(AiConstants.OLLAMA_WIZARD_MATH);
        String request = "Explain French Revolution";
        String response = model.generate(request);

        AiBeans.printModelDetails(AiConstants.LLM_OLLAMA, AiConstants.OLLAMA_WIZARD_MATH);
